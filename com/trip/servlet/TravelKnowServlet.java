...
/**
 * Servlet implementation class WenziServlet
 */
@WebServlet("/travelKnow")
public class TravelKnowServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public TravelKnowServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			request.getRequestDispatcher("/travelKnow.jsp").forward(request, response);
		} catch (SQLException e) {
